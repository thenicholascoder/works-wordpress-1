...
},{}],"Qouf":[function(require,module,exports) {
"use strict";
/**
 * Initialize Splide
 */
...
var splideTemplate1 = function splideTemplate1() {
  var carousel = document.querySelector('.js-splide');
  console.log("this runs", carousel)
  if (carousel) {
    new Splide('.js-splide').mount();
  }
};
...
},{"./components/forEachPolyfill":"Y661","./components/splide":"Qouf"}]},{},["Rgmk"], null)
